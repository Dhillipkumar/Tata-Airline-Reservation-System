...
function validation(){
    ...
    else if(!letters.test(document.paynameForm.Name.value)){
        alert("name should contain alphabets only!");
        return false;
    }else  if(document.paynameForm.card.value==""||document.paynameForm.card.value==null){
        alert("card field is empty!");
        return false;
    }else  if(!document.paynameForm.card.value.match(phoneno)){
        alert("card number is invaild!");
        return false;
    }
    else if(document.paynameForm.Month.value==""||document.paynameForm.Month.value==null){
        alert("Month field is empty!");
        return false;
    }
    else if(isNaN(document.paynameForm.Month.value))
    {
        alert("Month must be Number only");
        return false;
    }
   
    else if(document.paynameForm.Year.value==""||document.paynameForm.Year.value==null){
        alert("Year field is empty!");
        return false;
    }
    else if(isNaN(document.paynameForm.Year.value))
    {
        alert("Year must be Number only");
        return false;
    }
    else if(document.paynameForm.Year.value<year){
        alert("your card is experied");
        return false;
    }
    else if(document.paynameForm.Year.value==year && document.paynameForm.Month.value<month){
        alert("your card is experied");
        return false;
    }

    else if(document.paynameForm.cvv.value==""||document.paynameForm.cvv.value==null){
        alert("cvv field is empty!!!");
        return false;
    }
    else if(isNaN(document.paynameForm.cvv.value))
    {
